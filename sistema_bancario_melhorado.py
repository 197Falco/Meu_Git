#Evolução do sistema bancario
#Deixar código mais modularizado, criar funções p as operações existentes:
# 1 sacar
# 2 depositar
...
def criar_usuario(usuarios):
    ...
    endereco = input("Infome endereço (logradouro, nro - bairro - cidade/sigla estado): ")
